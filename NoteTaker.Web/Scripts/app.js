...
var NoteList = React.createClass({
    ...
    render: function () {
        var noteNodes = this.props.data.map(function (note, index) {
            ...
            return React.createElement(
                Note,
                { key: index, author: note.Author, note: note },
                note.Text
            );
        });
        return React.createElement(
...
var NoteForm = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'form',
            { className: 'noteForm', onSubmit: this.handleSubmit },
            React.createElement('input', { id: 'namebox', type: 'text', placeholder: 'Your name', ref: 'authorsFirstName' }),
...
ReactDOM.render(React.createElement(NoteBox, { url: '/notes', submitUrl: '/notes/new', pollInterval: 2000 }), document.getElementById('content'));

},{"moment":2,"showdown":3}],2:[function(require,module,exports){
//! moment.js
//! version : 2.13.0
